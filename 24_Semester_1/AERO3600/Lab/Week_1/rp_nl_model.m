...
Delta = (4 * p.Jp + p.Lp^2 * p.mp) * (4 * p.Jr + p.mp * (p.Lp^2 + 4 * Lr^2)) ...
...
dx3 = (p.Lp*p.mp*sin(x2)/Delta) * (-2 * x3^2 * p.Lp^2 * p.Lr * p.Lr * p.mp * cos(x2)^2 - ...
       2 * x3 * x4 * p.Lp * cos(x2) * (4 * p.Jp + p.Lp^2 * p.mp) ...
       + 2 * x4^2 * p.Lr * (4 * p.Jp + p.Lp^2 * p.mp) + 4 * p.g * p.Lp * p.Lr * p.mp * cos(x2)) ...
       - 4 * p.km^2 * (4 * p.Jp + p.Lp^2 * p.mp) * x3 / (p.Rm * Delta) ...
       + 4 * p.km * (4 * p.Jp + p.Lp^2 * p.mp) * vm / (p.Rm * Delta);

dx4 = (p.Lp * p.mp * sin(x2) / Delta) * (p.Lp * cos(x2) * (x3^2 * (4 * p.Jr + p.Lp^2 * p.mp + 4 * p.Lr^2 * p.mp) ...
       - 4 * x4^2 * p.Lr^2 * p.mp) - x3^2 * p.Lp^2 * p.mp * cos(x2)^3 ...
